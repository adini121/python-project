...
content_list,csv_filename = get_all_processed_contents('amo_mv1',bedrock_mv1_reference_version_sessionId_table,bedrock_mv1_compare_version_sessionId_table)
write_in_csv(fields=fields, content_list=content_list,csv_filename="BEDROCK-TEST")