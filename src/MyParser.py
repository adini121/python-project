...
IGNORE_ACTION = []
def do_comparison(column_names, app_name, ref_sessionId_table_name, comp_sessionId_table_name,test_number,ref_sessionId, comp_sessionId,actions_in_reference_sessionId, actions_in_comp_sessionId, id_of_action_in_ref_sessionId_action_file, id_of_action_in_comp_sessionId_action_file):
    """ do comparison """
    """ For printing:
    ...
    if len(actions_in_reference_sessionId) > len(actions_in_comp_sessionId):
     ...
     # len(actions_in_reference_sessionId)
    # print len(actions_in_reference_sessionId), len(actions_in_comp_sessionId)

    list = []
    # humanfriendly_results=[[app_name,ref_sessionId_table_name[-5:], comp_sessionId_table_name[-5:],test_number, list[-1]]]

    for key in number_of_actions_in_reference_sessionId:

        # """ Code to generate ImageDiff """
        # num = '%d' % (test_number)
    ...
    humanfriendly_results=[app_name,ref_sessionId_table_name[-5:], comp_sessionId_table_name[-5:],test_number, result]
...
def main(ref_sessionId_table_name, comp_sessionId_table_name, action_files_dir, app_name):
    ...
    column_names = ['App Name','reference version', 'comparabale version','Test Number', 'Test Result']
