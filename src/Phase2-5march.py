        ...
        if item in ["reorder", "changed", "deleted", "added"]:
            for key, value in elementdict.items():
                ...
                for element in value:
                    ...
                    if dictionary.get(item + title) is None:
                        dictionary[item + title] = value[element]
                    else:
                        past_value = int(dictionary[item + title])
                        dictionary[item + title] = past_value + int(value[element])
...
def write_in_csv(content_list, fields,csv_filename):
    print csv_filename
    try:
        with open('/Users/adityanisal/arbit/'+csv_filename+'.csv', 'a') as csvfile:
...
fields = [
    ...
    # "clickElementDiff",
    # "implicitWaitdiff",'deletedpartiallinktext', 'deletedcssselector', 'addedid', 'addedlinktext', 'addedname', 'addedclassname', 'deletedid', 'addedcssselector', 'changedid', 'changedtagname', 'changedcssselector', 'deletedclassname', 'changedxpath', 'changedname', 'deletedlinktext', 'changedclassname', 'deletedname', 'deletedxpath', 'addedxpath', 'addedtagname', 'changedpartiallinktext', 'addedpartiallinktext', 'deletedtagname', 'changedlinktext',
    # "setTimeoutDiff"
    'changedxpath','deletedxpath', 'addedxpath','changedpartiallinktext','deletedpartiallinktext','addedpartiallinktext', 'changedclassname','deletedclassname','addedclassname',
    'changedlinktext','deletedlinktext','addedlinktext','changedname','deletedname','addedname','changedcssselector','deletedcssselector','addedcssselector',
    'changedtagname','deletedtagname','addedtagname','changedid','deletedid','addedid','implicitWaitdiff'
    ]
...
bedrock_mv1_reference_version_sessionId_table='sessionids_mv2_2015_06_15'
bedrock_mv1_compare_version_sessionId_table='sessionids_mv2_2015_07_15'
...
content_list,csv_filename = get_all_processed_contents('bedrock_mv1',bedrock_mv1_reference_version_sessionId_table,bedrock_mv1_compare_version_sessionId_table)
write_in_csv(fields=fields, content_list=content_list,csv_filename="5feb-AMO-Less-Columns")