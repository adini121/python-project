...
#                   "implicitWaitdiffDiff": implicit_wait_diff
#     }
#     return dictionary
#
#
...
#         if item in ["getDiff", "implicitWaitdiffDiff"]:
#             dictionary[item] = elementdict
#
#     return dictionary
#
#
# def write_in_csv(content_list, fields):
...
# content_list = get_all_processed_contents('fireplace_mv1',fireplace_mv1_reference_version_sessionId_table,fireplace_mv1_compare_version_sessionId_table)
# print content_list
# write_in_csv(fields=fields, content_list=content_list)
