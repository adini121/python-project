...
def write_in_csv(content_list, fields,csv_filename):
    print csv_filename
    try:
        with open('/Users/adityanisal/PythonScriptsOutput/'+csv_filename+'.csv', 'a') as csvfile:
...
bedrock_reference_version_sessionId_table= 'sessionids_mv1_2015_04_30'
...
write_in_csv(fields=fields, content_list=content_list,csv_filename="phase2-bedrock")
